...
namespace StargazingHill.Editor
{
    ...
    internal static class CompassSceneInstaller
    {
        ...
        private static readonly Vector3 CompassPosition = new Vector3(6.25f, 2.50f, 4.95f);
        ...
        internal static void InstallForBuild(Scene scene)
        {
            ...
            compass.transform.position = CompassPosition;
            ...
            needlePivot.transform.localPosition = new Vector3(0f, 0.065f, 0f);
            CreateNeedleHalf("NorthRed", needlePivot.transform, 0.035f, northMaterial);
            CreateNeedleHalf("SouthWhite", needlePivot.transform, -0.035f, southMaterial);

            BoxCollider collider = compass.AddComponent<BoxCollider>();
            collider.center = new Vector3(0f, 0.055f, 0f);
            collider.size = new Vector3(0.20f, 0.12f, 0.20f);
        ...
        internal static void ValidateScene()
        {
            ...
            if ((compass.transform.position - CompassPosition).sqrMagnitude > 0.0001f)
                throw new InvalidOperationException("Local handheld compass dock position drifted.");
        }
        ...
        private static void CreateNeedleHalf(string name, Transform parent, float centerZ, Material material)
        {
            ...
            half.transform.localScale = new Vector3(0.010f, 0.004f, 0.070f);
