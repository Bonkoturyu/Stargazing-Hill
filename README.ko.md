...
환경, 실제 별하늘, 대기 소산, 전역 공유 22개 지점 선택기, 달 계산, 유성 시스템, YamaPlayer 표준 재생 목록 작업 흐름, 드로잉 도구, 5개 언어 패널, 인원 및 입퇴장 기록, 디버그 조작, 로컬 편의 설정을 구현했습니다. 새 설정 보드는 Unity 컴파일과 저장된 Scene 구조 검증을 통과했으며, Windows／Android／iOS 실제 기기 최종 검증은 아직 진행 중입니다.
