...
短い芝生の草原、小さな丘と一本木、淡い固定照明の中で、全員で共有する20か所の観測地点と現実の時刻に連動した星空と月を眺めることを主題とする。

## コア要素

- 20か所からGlobal選択した観測地点の緯度・東経と現実の時刻に連動する実在星空
- 現在時刻に連動する月の位置
- 毎時00分の流星演出
...
CC0テクスチャの±250m草原、単一Colliderの小丘、CC0の一本木とピクニックスポット、HYG v4.1の全天球星空、地平線の空気遠近と大気消散、Global共有の20観測地点、topocentric月位置、IMO 2026主要11流星群、状態表示付き毎時流星イベント、YamaPlayer 2.0.0-beta.7、QvPen 3.3.15、購入済みUnyStylus v1.3、5言語の説明・Debug・観測地点・人数・入退室履歴まで実装済み。月位置は東京のUSNO基準5日時で高度・方位とも0.10°以内。ClientSim複数人とPC / Android / iOS実機の最終検証は未完了。
