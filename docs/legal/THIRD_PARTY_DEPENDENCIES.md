...
|---|---|---|---|---|
| VRChat SDK Base / Worlds | 3.10.4 | VRChatワールド | VRChat公式VPM package。各packageの `license.txt` は https://hello.vrchat.com/legal/sdk を参照。取得済みpackageとmanifestを2026-08-12に照合 | Confirmed |
